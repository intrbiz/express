...
public class TestEquality
{
    ...
    @Test
    public void testGtEq4()
    {
        ValueExpression ve = new ValueExpression(this.context, "#{2 gteq 1}");
        Object o = ve.get(this.context, null);
        assertThat(o, is(instanceOf(Boolean.class)));
        assertThat((Boolean) o, is(equalTo(true)));
    }
    ...
    @Test
    public void testGtEq5()
    {
        ValueExpression ve = new ValueExpression(this.context, "#{1 gteq 1}");
        Object o = ve.get(this.context, null);
        assertThat(o, is(instanceOf(Boolean.class)));
        assertThat((Boolean) o, is(equalTo(true)));
    }
    ...
    @Test
    public void testGtEq6()
    {
        ValueExpression ve = new ValueExpression(this.context, "#{1 gteq 2}");
        Object o = ve.get(this.context, null);
        assertThat(o, is(instanceOf(Boolean.class)));
        assertThat((Boolean) o, is(equalTo(false)));
    }
